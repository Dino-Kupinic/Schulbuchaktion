...
<template>
  <div class="flex flex-wrap justify-center h-screen">
    <div class="w-full flex justify-center items-center sm:mb-0">
      <Logo/>
    </div>
    <UContainer class="w-full h-auto mr-6 ml-6">
      ...
      <div class="sm:flex sm:justify-center">
        <UContainer
          class="w-full p-0 sm:w-96 sm:pl-0 sm:border sm:border-solid sm:border-neutral-200 sm:p-8 sm:rounded-md sm:shadow-md sm:shadow-neutral-300">
